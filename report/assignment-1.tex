...
\begin{tabular}{|c|c|}
\hline
\multicolumn{2}{|c|}{Complexity per class}\\
\hline
...
\begin{tabular}{|c|c|}
\hline
\multicolumn{2}{|c|}{Lack of cohesion (LCOM4)}\\
\hline
\textbf{Package} & \textbf{Classes}\\
\hline
...
\begin{tabular}{|c|c|}
\hline
\multicolumn{2}{|c|}{Too much responsibility (Afferent Coupling)}\\
\hline
\textbf{Package} & \textbf{Classes}\\
\hline
...
\begin{tabular}{|c|c|}
\hline
\multicolumn{2}{|c|}{Instability (Efferent/Afferent coupling ratio)}\\
\hline
\textbf{Package} & \textbf{Classes}\\
\hline
