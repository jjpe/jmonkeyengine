...
\begin{tabular}{|c|c|}
\hline
\multicolumn{2}{|c|}{\bfseries Complexity per class}\\
\hline
...
\begin{tabular}{|c|c|}
\hline
\multicolumn{2}{|c|}{\bfseries Lack of cohesion (LCOM4)}\\
\hline
\textbf{Package} & \textbf{Classes}\\
\hline
...
\begin{tabular}{|c|c|}
\hline
\multicolumn{2}{|c|}{\bfseries Too much responsibility (Afferent Coupling)}\\
\hline
\textbf{Package} & \textbf{Classes}\\
\hline
...
\begin{tabular}{|c|c|}
\hline
\multicolumn{2}{|c|}{\bfseries Instability (Efferent/Afferent coupling ratio)}\\
\hline
\textbf{Package} & \textbf{Classes}\\
\hline
