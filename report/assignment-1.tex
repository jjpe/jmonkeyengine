...
The packages \verb|com.jme3.scene|, \verb|com.jme3.scene| and
\verb|com.jme3.renderer| together violate the ADP on the package
level:\\
\includegraphics[scale=0.5]{figures/adp-violation.png}
